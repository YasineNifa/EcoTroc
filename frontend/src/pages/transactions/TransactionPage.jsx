...
const TransactionsPage = () => {
  ...
  // Callback to refresh the list after an action
  const onActionSuccess = () => {
    // A simple way to trigger a refresh is to clear the selection,
    // which can prompt the list to refetch or simply update its state.
    // A more robust solution might involve a dedicated refresh function.
